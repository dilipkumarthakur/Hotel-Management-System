...
public class CustomerDetailBill extends javax.swing.JFrame {
    ...
    jTextField1.setText(myFormate.format(cal.getTime()));
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Search CheckOUT Date");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 80, 180, -1));

        jTextField1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 80, 194, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Mobile Number", "Nationality", "Gender", "Email", "Idproof", "Address", "Check IN Date", "Room Number", "Bed", "Room Type", "Price Per Day", "Number of Days Stay", "Total Amont", "Check Out Date"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 1250, 340));

        jLabel4.setFont(new java.awt.Font("Algerian", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 0, 0));
        jLabel4.setText("*CLICK ON TABLE ROW TO OPEN BILL ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 460, -1, -1));
    ...
    try {
        ...
        rs.close();
    } catch (Exception e) {  // <-- Moved the catch block inside the method
    ...
    try {
        ...
        while (rs.next()) {
            model.addRow(new Object[]{
                ...
                rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8),
                rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12),
                rs.getString(13), rs.getString(14), rs.getString(15), rs.getString(16)  // Fixed column index
            });
        }
        rs.close();
    } catch (Exception e) {
