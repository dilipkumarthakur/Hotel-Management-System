...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 32, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1011, 23, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1189, 23, -1, -1));

        jLabel1.setText("Search By Name Or Email");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(339, 157, -1, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(528, 154, 251, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1123, 151, -1, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(806, 151, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 211, 1180, 560));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null,"Do you really what to Close Application","Select" ,JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            System.exit(0);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int a = JOptionPane.showConfirmDialog(null,"Do you really what to LogOut","Select" ,JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            setVisible(false);
...
//            if(a==0)
//            {
//                InsertUpdateDelete.setData("update users set status='"+status+"' where email='"+email+"'", "Status chnage Successfully");
//                setVisible(false);
//                new adminHome().setVisible(true);
//            }
//        }catch(Exception e)
...
//        }
    ...
    // Toggle between approved and pending status
    ...
    try {
        ...
        if (a == 0) {
            ...
            InsertUpdateDelete.setData("UPDATE users SET status='" + newStatus + "' WHERE email='" + email + "'", "Status changed successfully");
